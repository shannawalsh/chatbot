...
plot_description = """
In the heart of the bustling metropolis of Astoria, the old Henderson House stands as a
...
book_summary = get_response_from_openai_chatbot(model, messages)
...
# determine sentiment in book review
for review in book_reviews:
    ...
    sentiment = get_response_from_openai_chatbot(model, review_messages)
